...
public class ServiceRequest implements java.io.Serializable {
	...
	@org.kie.api.definition.type.Label(value = "Service Id")
	private java.lang.String servId;
	@org.kie.api.definition.type.Label(value = "Credit Approved")
	private java.lang.Boolean creditApproved;
	@org.kie.api.definition.type.Label(value = "Contractive Active")
	private java.lang.Boolean contractActive;
	@org.kie.api.definition.type.Label(value = "Account Balance ")
	private java.lang.Integer accBal;
	@org.kie.api.definition.type.Label(value = "Service Type")
